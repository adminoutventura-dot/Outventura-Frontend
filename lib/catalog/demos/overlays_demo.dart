          ...
          Wrap(
            ...
            children: [
              SecondaryButton(
                ...
                onPressed: () => mostrarDialogoAprobacion(context, reservationsFake[0], () async {}),
              ),
              SecondaryButton(
                label: 'Rechazar',
                borderColor: cs.error,
                backgroundColor: cs.surface,
                onPressed: () => mostrarDialogoRechazo(context, reservationsFake[0], () async {}),
              ),
              SecondaryButton(
                label: 'Cancelar',
                borderColor: cs.tertiary,
                backgroundColor: cs.surface,
                onPressed: () => mostrarDialogoCancelacion(context, reservationsFake[0], () async {}),
              ),
              SecondaryButton(
                label: 'Registrar devolución',
                borderColor: cs.secondary,
                backgroundColor: cs.surface,
                onPressed: () => mostrarDialogoDevolucion(context, reservationsFake[0], () async {}),
              ),
            ],
          ),
