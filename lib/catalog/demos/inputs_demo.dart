    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          Text(
            'AppImagePickerField – Sin imagen',
            style: tt.titleMedium?.copyWith(color: cs.onSurface),
          ),
          const SizedBox(height: 8),
          ...
          const SizedBox(height: 16),
          Text(
            'AppImagePickerField – Con imagen (asset)',
            style: tt.titleMedium?.copyWith(color: cs.onSurface),
          ),
          const SizedBox(height: 8),
                ...
                builder: (BuildContext ctx) => StatefulBuilder(
                  builder: (BuildContext ctx2, StateSetter setS) =>
                      FilterBottomSheetContent(
                          ...
                          FilterGrupo(
                            ...
                            chips: [
                              FilterChipSpec(
                                ...
                                onToggle: () => setS(() {
                                  sel.contains('Pendiente')
                                      ? sel.remove('Pendiente')
                                      : sel.add('Pendiente');
                                }),
                              ),
                              FilterChipSpec(
                                ...
                                onToggle: () => setS(() {
                                  sel.contains('Confirmada')
                                      ? sel.remove('Confirmada')
                                      : sel.add('Confirmada');
                                }),
                              ),
                              FilterChipSpec(
                                ...
                                onToggle: () => setS(() {
                                  sel.contains('Cancelada')
                                      ? sel.remove('Cancelada')
                                      : sel.add('Cancelada');
                                }),
                              ),
                            ],
                        ...
                        fechaDesde: desde,
                        fechaHasta: hasta,
                        onFechaDesdeChanged: (DateTime d) =>
                            setS(() => desde = d),
                        onFechaHastaChanged: (DateTime d) =>
                            setS(() => hasta = d),
                        onFechasClear: () => setS(() {
                          desde = null;
                          hasta = null;
