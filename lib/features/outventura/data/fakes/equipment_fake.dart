...
final List<Equipment> equipmentFake = [
  ...
  const Equipment(
    ...
    categories: [Category.camping, Category.montana],
    totalUnits: 10,
    availableUnits: 8,
  ...
  const Equipment(
    ...
    categories: [Category.camping, Category.nieve],
    totalUnits: 10,
    availableUnits: 10,
  ...
  const Equipment(
    ...
    categories: [Category.montana, Category.nieve],
    totalUnits: 15,
    availableUnits: 15,
    status: EquipmentStatus(id: 1, code: 'AVAILABLE'),
    pricePerDay: 3.0,
  ...
  const Equipment(
    ...
    categories: [Category.nieve, Category.montana],
    totalUnits: 8,
    availableUnits: 5,
